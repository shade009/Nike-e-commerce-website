...
import { Mail, Lock, Eye, EyeOff, AlertCircle, Truck, Shield, Percent } from 'lucide-react';
    ...
    <div className="auth-page">
      ...
      >
        ...
        <div className="auth-brand-content">
          ...
          <p>Sign in to access your account, track orders, and unlock member exclusives.</p>
